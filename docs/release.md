...
- 当前处于 **v0.x** 阶段：允许破坏性变更，升级前必须查看 CHANGELOG；
- v0.12.0（2026-08-08）为本仓库首次经 CI 全绿验证的正式发布；
- 若后续对外稳定，建议在 v1.0.0 冻结 API 并用 apidiff 建立基线。
...
| 版本 | 说明 |
| --- | --- |
| v0.12.0 | 工业化基线：全链路零分配、Field 强类型化、有界背压、CI 三平台验证 |
